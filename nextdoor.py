...
driver.get("https://nextdoor.com/news_feed/?") # Put url in place of <URL of Neighborhood's Newsfeed>

# Log In
username = driver.find_element_by_id("id_email")
password = driver.find_element_by_id("id_password")

username.send_keys(os.getenv("NEXTDOOR_USERNAME")) # Put your username in place of <Username>
password.send_keys(os.getenv("NEXTDOOR_PASSWORD")) # Put your password in place of <Password>
